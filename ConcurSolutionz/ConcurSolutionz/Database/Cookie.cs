...
namespace ConcurSolutionz.Database
{
    public class Cookie
    {
        ...
        private Cookie(CookieBuilder cookieBuilder)
        {
            ...
            ExpiryDate = cookieBuilder.ExpiryDate;
            bm_sz = cookieBuilder.bm_sz;
            TAsessionID = cookieBuilder.TAsessionID;
            ak_bmsc = cookieBuilder.ak_bmsc;
            _abck = cookieBuilder._abck;
            OTSESSIONAABQRD = cookieBuilder.OTSESSIONAABQRD;
            JWT = cookieBuilder.JWT;
            bm_sv = cookieBuilder.bm_sv;
        }

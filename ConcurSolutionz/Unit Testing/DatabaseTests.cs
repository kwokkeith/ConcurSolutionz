...
namespace Unit_Testing
{
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    // Ensure that %USERPROFILE%/Pictures/IMG_5669.jpg exists before running tests
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    public class DatabaseTests : IClassFixture<DBSetup>
    {
        ...
        public void GetFilesFromWD_ReturnsBothFilesAndFolders()
        {
            ...
            dbinstance.Setwd(path);
            var files = dbinstance.GetFilesFromWD();
        ...
        [Fact(Skip = "Will have to implement calling Entry Subsystem")]
        public void FileSelectByFileName_SelectsEntryWithGivenName()
        {
            ...
            // Assert  
            Assert.Equal(Path.Combine(path1 + fileName), dbinstance.Getwd());
        }
        ...
        [Fact(Skip = "Will have to implement calling Entry Subsystem")]
        public void FileSelectByFilePath_SelectsEntryWithGivenPath()
        {
            ...
            // Assert  
            Assert.Equal(Path.Combine(path1, fileName+".entry"), dbinstance.Getwd());
        }
